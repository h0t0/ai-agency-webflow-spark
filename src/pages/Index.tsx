      ...
      <section className="pt-32 pb-20 px-6">
        <div className="container mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
            AI Solutions for
            <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent"> Business Transformation</span>
          </h1>
      ...
      <section className="py-20 px-6 bg-slate-800/50">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="bg-slate-800/60 border-slate-600/30 backdrop-blur-sm p-6 hover:bg-slate-700/60 transition-all">
              <CardHeader>
              ...
              <CardContent>
                <Button className="w-full bg-blue-500 hover:bg-blue-600 text-white">Read More</Button>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-800/60 border-slate-600/30 backdrop-blur-sm p-6 hover:bg-slate-700/60 transition-all">
              <CardHeader>
                <Target className="h-12 w-12 text-blue-300 mb-4" />
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 gap-12">
            <div className="flex items-center">
              <Award className="h-48 w-48 text-blue-400" />
            </div>
            <div>
              <Badge className="mb-6 bg-blue-500/20 text-blue-300 border-blue-400/30">
                🏆 About NeuralFlow AI
              ...
              <Link to="/about">
                <Button className="bg-blue-500 hover:bg-blue-600 text-white">Learn More About Us</Button>
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="bg-slate-800/60 border-slate-600/30 backdrop-blur-sm p-8">
              <CardHeader>
                <Badge className="mb-4 bg-emerald-500/20 text-emerald-300 border-emerald-400/30">E-commerce</Badge>
              ...
              <CardContent>
                <Button className="bg-blue-500 hover:bg-blue-600 text-white">View Case Studies</Button>
              </CardContent>
            </Card>

            <Card className="bg-slate-800/60 border-slate-600/30 backdrop-blur-sm p-8">
              <CardHeader>
                <Badge className="mb-4 bg-cyan-500/20 text-cyan-300 border-cyan-400/30">Manufacturing</Badge>
